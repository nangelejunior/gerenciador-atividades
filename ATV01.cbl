           ...
           03      WS-AUXILIARES.
             ...
             05    WS-MENSAG.
               07  FILLER          PIC     X(08)         VALUE
                                   ' MSG..: '.
               07  WS-MSG          PIC     X(73)         VALUE SPACES.
             05    WS-OPT          PIC     X(01)         VALUE SPACES.
             05    WS-TECLA        PIC     X(02).
               88  CN-ESC                                VALUE '01'.
               88  CN-PF12                               VALUE '93'.
             05    WS-FLAG-STATUS  PIC     X(01).
               88  CN-INSERIR                            VALUE 'I'.
               88  CN-ATUALIZAR                          VALUE 'U'.
      *
      ******************************************************************
      *    AREA DE FILE STATUS                                         *
      ******************************************************************
           ...
           03      WS-MENSAGENS.
             ...
             05    WS-MSGARQ-901.
               07  FILLER          PIC     X(50)         VALUE
                   '#ATV01.901I - ERRO NO OPEN ARQ. SYS010    STATUS: '.
               07  WS-RETCOD-901   PIC     X(02)         VALUE ZEROS.
      *
             05    WS-MSGARQ-902.
               07  FILLER          PIC     X(50)         VALUE
                   '#ATV01.902I - ERRO NO READ ARQ. SYS010    STATUS: '.
               07  WS-RETCOD-902   PIC     X(02)         VALUE ZEROS.
      *
             05    WS-MSGARQ-903.
               07  FILLER          PIC     X(50)         VALUE
                   '#ATV01.903I - ERRO NO WRITE ARQ. SYS010   STATUS: '.
               07  WS-RETCOD-903   PIC     X(02)         VALUE ZEROS.
      *
             05    WS-MSGARQ-904.
               07  FILLER          PIC     X(50)         VALUE
                   '#ATV01.904I - ERRO NO REWRITE ARQ. SYS010 STATUS: '.
               07  WS-RETCOD-904   PIC     X(02)         VALUE ZEROS.
      *
             05    WS-MSGARQ-905.
               07  FILLER          PIC     X(50)         VALUE
                   '#ATV01.905I - ERRO NO CLOSE ARQ. SYS010   STATUS: '.
               07  WS-RETCOD-905   PIC     X(02)         VALUE ZEROS.
      *
             05    WS-MSGARQ-999.
               07  FILLER          PIC     X(50)         VALUE
                   '#ATV01.999I - EXECUTADO COM SUCESSO               '.
      *
      ******************************************************************
      *    AREA DE SUBROTINAS                                          *
      ******************************************************************
      ...
      *
           EVALUATE TRUE
               WHEN CN-SYS010-OK
                   SET CN-ATUALIZAR    TO TRUE
               WHEN CN-SYS010-DPL
                   SET CN-ATUALIZAR    TO TRUE
               WHEN CN-SYS010-NOK
                   SET CN-INSERIR      TO TRUE
               WHEN OTHER
      ...
      ******************************************************************
      *
           ACCEPT WS-RECEBIM           FROM DATE YYYYMMDD.
           ACCEPT WS-DT-TERM           FROM DATE YYYYMMDD.
           ACCEPT WS-HR-TERM           FROM TIME.
      *
           DISPLAY SC-SCREEN.
      *
           ...
           PERFORM                     UNTIL AC-CAMPO EQUAL   2  OR
               ...
               EVALUATE AC-CAMPO
                   ...
                   WHEN 5
                       ACCEPT SC-HR-TERM
                   WHEN 6
                       ACCEPT SC-HR-ESFORCO
                   WHEN 7
                       ACCEPT SC-NM-SOLIC
                   WHEN 8
                       ACCEPT SC-TEL-SOLIC
                   WHEN 9
                       ACCEPT SC-RAMAL-SOLIC
                   WHEN 10
                       ACCEPT SC-LINGUAGEM
                   WHEN 11
                       ACCEPT SC-NM-MOD
      ...
      *
           DISPLAY SC-SCREEN.
      *
           DISPLAY 'ESC - CANCELAR / F12 - GRAVAR'
                                       AT 2502.
      *
      ...
      ******************************************************************
      ******************************************************************
      *    ROTINA PARA GRAVAR REGISTRO                                 *
      ******************************************************************
       RTGRAVAR                        SECTION.
      ******************************************************************
      *
           WRITE FD-SYS010             FROM WS-SYS010.
      *
